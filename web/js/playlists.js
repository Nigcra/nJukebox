...
function initializeAutoDjAndPlaylists() {
  ...
  // the label along through toggleAutoDj().
  if (typeof loadAutoDjSettings === 'function') {
    loadAutoDjSettings();
  }

  if (typeof updateAutoDjStatusDisplay === 'function') {
    updateAutoDjStatusDisplay(window.isAutoDjActive === true);
  }
